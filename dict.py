views_dict = {
    ...
    'hi': {
        ...
        'rtext': 'Ты можешь выбрать Начать игру или Рассказать правила',  # Текст для переспроса
        'rtts': 'Ты можешь выбрать Начать игру или - Рассказать правила',
    ...
    'exit': {
        'text': 'Спасибо за игру! Баллов в твоей копилке ',
        'tts': 'Спасибо за игру! Баллов в твоей копилке ',  # Собирать разметку по частям!
        'text1': '%scores%',
        'tts1': '%scores%',  # Сделать разметку!
        'text2': '',
        'tts2': '',  # Сделать разметку!
    ...
    'scores': {
        'text': 'Баллов в твоей копилке ',
        'tts': 'Баллов в твоей копилке ',  # Сделать разметку!
        'text1': '%scores%',
        'tts1': '%scores%',  # Сделать разметку!
        'text2': '',
        'tts2': '',  # Сделать разметку!
    ...
    'can_you': {
        ...
        \n\nЯ сохраню твои баллы в копилке и расскажу об успехах других игроков.''',
        ...
        потеряешь 1 балл. Я сохраню твои баллы в копилке и расскажу об успехах других игроков.''',  # Сделать разметку!
