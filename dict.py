views_dict = {
    ...
    'can_you': {
        ...
        'tts': '''Я могу сыграть с тобой в игру Угадай +АйТи слово. 
        Я дам короткое описание слова, а ты по описанию выберешь правильный ответ. 
        За каждый правильный ответ ты получишь 3 балла. 
        А за неправильный ответ потер+яешь 1 балл. 
        Я храню твои баллы в копилке до конца игры.''',  # 'и расскажу об успехах других игроков' - пока нет
        'rtext': 'Вернемся в игру или Повторить?',  # Текст для переспроса
        'rtts': 'Вернемся в игр+у - или Повтори ть?',  # Сделать разметку!
        'butt': ('Вернуться в игру', 'Повтори', 'Выйти'),
        'ans': {
            'return': {'view': 'return'},
            'YANDEX.BOOK.NAVIGATION.PREVIOUS': {'view': 'return'},
